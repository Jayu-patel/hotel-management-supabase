...
export default function AddHotelPage() {
  ...
  const validateForm = () => {
    ...
    if (!formData.price_per_night) {
      newErrors.price_per_night = "Price is required";
    } else if (parseFloat(formData.price_per_night) <= 0) {
...
//       if (insertError){
//         return toast.error(insertError)
//       }
...
//   if(imageLoad) return <div className='w-[100%] h-[calc(100vh-100px)] grid place-items-center'> <Loader/> </div>
//   return (
//     <div className="w-full h-[calc(100vh-100px)] overflow-y-scroll">
//         <div className="max-w-2xl mx-auto p-8">
//             <h1 className="text-3xl font-bold mb-6 text-center text-gray-800">
...
//                     id="hotelImage"
//                     />
//                     <label htmlFor="hotelImage" className="cursor-pointer text-gray-500">
//                     {formData.image ? (
